...
const Navbar: React.FC = () => {
	...
	return (
		<nav className=' w-screen h-auto tablet:h-16 justify-between text-2xl bg-navbg flex align-middle text-white min-w-full fixed left-0 bottom-0 border-t-2  tablet:border-t-0 tablet:top-0 tablet:border-b border-gray-600 z-20'>
			<Link
				to='/'
