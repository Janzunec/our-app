				...
				<>
					<div className='flex flex-row w-screen border-4 border-gray-700 rounded-2xl p-2 mt-16 tablet:w-max m-auto'>
						<img
							...
							alt='activity image'
							className='w-auto h-20 rounded-full border-2 border-gray-600 tablet:h-32'
						/>

						<div className='flex flex-col w-full'>
							<div className='pl-2 items-center h-full flex w-full text-sm border-2 rounded-full border-gray-700 tablet:text-2xl p-3 px-10 pl-6'>
								{activity?.details}
							</div>
							<div className='pl-2 items-center h-full flex w-full text-sm border-2 rounded-full border-gray-700 tablet:text-2xl p-3 px-10 pl-6'>
								{activity?.state}
