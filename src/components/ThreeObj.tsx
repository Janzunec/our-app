    ...
    const loadReactLogo = glLoader.load(
      ...
      gltf => {
        ...
        const animate = () => {
          ...
          sizes.width >= 1280
            ? (reactLogo.rotation.y += (targetX - reactLogo.rotation.y) * 0.02)
          ...
          if (
            ...
            reactLogo.rotation.y += (targetX - reactLogo.rotation.y) * 0.015;
          } else {
            if (sizes.width >= 1280) {
              reactLogo.rotation.y < 0.5
          ...
          sizes.width >= 1280
            ? (reactLogo.rotation.x += (targetY - reactLogo.rotation.x) * 0.08)
